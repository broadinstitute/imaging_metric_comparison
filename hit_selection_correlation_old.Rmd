...
#filename <- "Pf_Gustafsdottir_random_700.rds" #"Pf_Gustafsdottir_fs.rds" 
...
```{r import data}
# import data
pf <- readRDS(file.path("..", "..", "input", "BBBC022_2013", "single_cells", filename)) # 7680x803
...
# save new dataset
pf %>%
  saveRDS("../../input/BBBC022_2013/single_cells/Hit_pearson_random_700_5963.rds")
...
```{r plot}
hist(random.replicate.cor.median,main="", xlim = range(-1, 1), col=rgb(0,0,1,1/4), xlab = "replicate correlation")
hist(comp.cor.median, main="", xlab="Median Replicate Correlation", xlim = range(-1, 1), col=rgb(1,0,0,1/4), add=T)
abline(v=thres, untf = FALSE)
legend("topleft", c("Random Replicate Correlation", "Replicate Correlation", "Threshold"), col=c(rgb(0,0,1,1/4), rgb(1,0,0,1/4), rgb(0,0,0,1/4)), lwd=7, bty = 'n', border = NA, cex=0.9)
