...
end.time <- Sys.time() # 57.82 (without feature selection)
time.taken <- end.time - start.time
time.taken
```
...
# save new dataset
pf %>%
  saveRDS("../../input/BBBC022_2013/single_cells/Hit_jaccard_30n_random_700_5994.rds")
...
```{r plot}
type1 <- rep("Random Replicate Distance", length(random.replicate.dist.median))
