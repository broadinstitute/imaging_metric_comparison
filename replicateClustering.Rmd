...
```{r import data}
# import data
pf <- readRDS("../input/Pf_Gustafsdottir_hitSelection_distJ.rds")
...
contingency.mat <- matrix(c(contingency.table[2,2], contingency.table[2,1], contingency.table[1,2], contingency.table[1,1]), nrow = 2, ncol = 2, byrow = TRUE)
