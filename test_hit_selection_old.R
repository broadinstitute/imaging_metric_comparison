...
files <- c("Pf_Gustafsdottir.rds", "Pf_Gustafsdottir_fs.rds")
feat.sel <- c(FALSE, TRUE)
n.feat <- c(50, 30)
seeds <- seq(from = 1, to = 200, by = 1)
...
ggsave(filename = 'hit_ratio_vs_seed.png', plot = hit_ratio_vs_seed_plot, width = 6, height = 6)